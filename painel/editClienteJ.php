...
<div class="row">
  ...
  <form id="formulario" name="form1" class="form-horizontal" action="editClienteJ.php?id=<?php echo $id;?>" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input name="rSocial" type="text" class="form-control" id="rSocial" value="<?php echo $editar["rSocial"];?>" placeholder="Digite seu nome e-mail mais usado">
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="cpf" class="col-sm-2 control-label">Nome Responsável</label>
      <div class="col-sm-10">
        <input name="nome"  type="text" class="form-control" id="nome" value="<?php echo $editar["nome"];?>" placeholder="Nome Responsavel">
      </div>
    </div>
    
    
     <div class="form-group">
      <label for="conjugue" class="col-sm-2 control-label">E-mail</label>
      <div class="col-sm-10">
        <input name="email" type="text" class="form-control" id="email" value="<?php echo $editar["email"];?>" placeholder="Digite e-mail">
      </div>
    </div>
